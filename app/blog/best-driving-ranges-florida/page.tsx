  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <main id="main-content" className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        {/* Image placeholder */}
        <div className="w-full h-64 bg-gradient-to-br from-green-100 to-green-200 rounded-xl flex items-center justify-center text-green-400 text-6xl mb-8" aria-label="Driving range image placeholder">
          ⛳
        </div>
