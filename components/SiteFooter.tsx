        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/" className="text-slate-400 hover:text-white transition-colors">All Ranges</Link></li>
              <li><Link href="/indoor-driving-ranges" className="text-slate-400 hover:text-white transition-colors">Indoor Ranges</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/contact?subject=Claim%20a%20Listing" className="text-slate-400 hover:text-white transition-colors">Claim a Listing</Link></li>
            </ul>
          </div>
